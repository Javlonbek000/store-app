...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String image,  String title,  int price,  int discount,  bool isLiked)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductModel() when $default != null:
return $default(_that.id,_that.image,_that.title,_that.price,_that.discount,_that.isLiked);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String image,  String title,  int price,  int discount,  bool isLiked)  $default,) {final _that = this;
switch (_that) {
case _ProductModel():
return $default(_that.id,_that.image,_that.title,_that.price,_that.discount,_that.isLiked);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String image,  String title,  int price,  int discount,  bool isLiked)?  $default,) {final _that = this;
switch (_that) {
case _ProductModel() when $default != null:
return $default(_that.id,_that.image,_that.title,_that.price,_that.discount,_that.isLiked);case _:
  return null;

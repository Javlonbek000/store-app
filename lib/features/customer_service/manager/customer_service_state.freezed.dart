...
/// Adds pattern-matching-related methods to [CustomerServiceState].
extension CustomerServiceStatePatterns on CustomerServiceState {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CustomerServiceState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CustomerServiceState() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CustomerServiceState value)  $default,){
final _that = this;
switch (_that) {
case _CustomerServiceState():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CustomerServiceState value)?  $default,){
final _that = this;
switch (_that) {
case _CustomerServiceState() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CustomerServiceStatus status,  List<Map<String, dynamic>> messages)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CustomerServiceState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CustomerServiceStatus status,  List<Map<String, dynamic>> messages)  $default,) {final _that = this;
switch (_that) {
case _CustomerServiceState():
return $default(_that.status,_that.messages);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CustomerServiceStatus status,  List<Map<String, dynamic>> messages)?  $default,) {final _that = this;
switch (_that) {
case _CustomerServiceState() when $default != null:
return $default(_that.status,_that.messages);case _:
  return null;
